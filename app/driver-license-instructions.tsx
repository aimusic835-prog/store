...
const styles = StyleSheet.create({
  ...
  checkmark: { fontSize: 20, color: '#c8ff00', marginRight: 12, marginTop: 2 },
  ...
  illustrationBox: { width: 200, height: 200, backgroundColor: '#c8ff00', borderRadius: 20,
    justifyContent: 'center', alignItems: 'center' },
  illustrationText: { fontSize: 80 },
  footer: { paddingHorizontal: 24, paddingBottom: Platform.OS === 'ios' ? 30 : 20, paddingTop: 8 },
  primaryButton: { backgroundColor: '#c8ff00', borderRadius: 12, padding: 18, alignItems: 'center', marginBottom: 12 },
  ...
  uploadButton: { flex: 1, backgroundColor: '#c8ff00', borderRadius: 12, padding: 18, alignItems: 'center' },
