...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#c8ff00', borderRadius: 12, padding: 18, alignItems: 'center' },
  ...
  saveButton: { flex: 1, backgroundColor: '#c8ff00', borderRadius: 12, padding: 18, alignItems: 'center' },
